...
/**
 * SQLite dialect of the registry schema. Column set and names match
 * `schema.pg.ts` exactly so the row mappers in `mappers.ts` are shared.
...
export const tx_hashes = sqliteTable('tx_hashes', {
