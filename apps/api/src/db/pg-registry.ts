...
/**
 * PostgreSQL-backed registry (node-postgres driver wrapped by drizzle). Used
 * when BRIDGESURE_DB_DRIVER=postgres. Same interface and table shape as the
 * SQLite registry; the row mappers are shared.
 */
export class PostgresRegistry implements TradeRegistry {
